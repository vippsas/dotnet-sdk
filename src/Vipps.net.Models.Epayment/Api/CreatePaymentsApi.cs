...
namespace Vipps.net.Models.Epayment.Api
{
    ...
    /// </summary>
    public interface ICreatePaymentsApiSync : IApiAccessor
    {
        ...
        /// <param name="createPaymentRequest">New &#x60;CreatePaymentRequest&#x60; body.</param>
        ...
        ApiResponse<CreatePaymentResponse> CreatePaymentWithHttpInfo(string idempotencyKey, string ocpApimSubscriptionKey, string merchantSerialNumber, CreatePaymentRequest createPaymentRequest, string vippsSystemName = default(string), string vippsSystemVersion = default(string), string vippsSystemPluginName = default(string), string vippsSystemPluginVersion = default(string), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICreatePaymentsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CreatePaymentResponse> CreatePaymentAsync(string idempotencyKey, string ocpApimSubscriptionKey, string merchantSerialNumber, CreatePaymentRequest createPaymentRequest, string vippsSystemName = default(string), string vippsSystemVersion = default(string), string vippsSystemPluginName = default(string), string vippsSystemPluginVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CreatePaymentResponse>> CreatePaymentWithHttpInfoAsync(string idempotencyKey, string ocpApimSubscriptionKey, string merchantSerialNumber, CreatePaymentRequest createPaymentRequest, string vippsSystemName = default(string), string vippsSystemVersion = default(string), string vippsSystemPluginName = default(string), string vippsSystemPluginVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICreatePaymentsApi : ICreatePaymentsApiSync, ICreatePaymentsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class CreatePaymentsApi : ICreatePaymentsApi
    {
        private Vipps.net.Models.Epayment.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePaymentsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public CreatePaymentsApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public CreatePaymentsApi(string basePath)
        {
        ...
        /// <returns></returns>
        public CreatePaymentsApi(Vipps.net.Models.Epayment.Client.Configuration configuration)
        {
        ...
        public CreatePaymentsApi(Vipps.net.Models.Epayment.Client.ISynchronousClient client, Vipps.net.Models.Epayment.Client.IAsynchronousClient asyncClient, Vipps.net.Models.Epayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Create a payment Create a new payment
        /// </summary>
        /// <exception cref="Vipps.net.Models.Epayment.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="idempotencyKey">Idempotency key for the request, ensures idempotent actions. See [idempotency](https://developer.vippsmobilepay.com/docs/knowledge-base/http-headers#idempotency)</param>
        /// <param name="ocpApimSubscriptionKey">The subscription key for a sales unit.  See [API keys](https://developer.vippsmobilepay.com/docs/knowledge-base/api-keys/).</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>CreatePaymentResponse</returns>
        public CreatePaymentResponse CreatePayment(string idempotencyKey, string ocpApimSubscriptionKey, string merchantSerialNumber, CreatePaymentRequest createPaymentRequest, string vippsSystemName = default(string), string vippsSystemVersion = default(string), string vippsSystemPluginName = default(string), string vippsSystemPluginVersion = default(string), int operationIndex = 0)
        {
            Vipps.net.Models.Epayment.Client.ApiResponse<CreatePaymentResponse> localVarResponse = CreatePaymentWithHttpInfo(idempotencyKey, ocpApimSubscriptionKey, merchantSerialNumber, createPaymentRequest, vippsSystemName, vippsSystemVersion, vippsSystemPluginName, vippsSystemPluginVersion);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CreatePaymentResponse</returns>
        public Vipps.net.Models.Epayment.Client.ApiResponse<CreatePaymentResponse> CreatePaymentWithHttpInfo(string idempotencyKey, string ocpApimSubscriptionKey, string merchantSerialNumber, CreatePaymentRequest createPaymentRequest, string vippsSystemName = default(string), string vippsSystemVersion = default(string), string vippsSystemPluginName = default(string), string vippsSystemPluginVersion = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'idempotencyKey' is set
            if (idempotencyKey == null)
            {
                throw new Vipps.net.Models.Epayment.Client.ApiException(400, "Missing required parameter 'idempotencyKey' when calling CreatePaymentsApi->CreatePayment");
            }

            // verify the required parameter 'ocpApimSubscriptionKey' is set
            if (ocpApimSubscriptionKey == null)
            {
                throw new Vipps.net.Models.Epayment.Client.ApiException(400, "Missing required parameter 'ocpApimSubscriptionKey' when calling CreatePaymentsApi->CreatePayment");
            }

            // verify the required parameter 'merchantSerialNumber' is set
            if (merchantSerialNumber == null)
            {
                throw new Vipps.net.Models.Epayment.Client.ApiException(400, "Missing required parameter 'merchantSerialNumber' when calling CreatePaymentsApi->CreatePayment");
            }

            // verify the required parameter 'createPaymentRequest' is set
            if (createPaymentRequest == null)
            {
                throw new Vipps.net.Models.Epayment.Client.ApiException(400, "Missing required parameter 'createPaymentRequest' when calling CreatePaymentsApi->CreatePayment");
            }
            ...
            localVarRequestOptions.Operation = "CreatePaymentsApi.CreatePayment";
            ...
            var localVarResponse = this.Client.Post<CreatePaymentResponse>("/v1/payments", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CreatePaymentResponse</returns>
        public async System.Threading.Tasks.Task<CreatePaymentResponse> CreatePaymentAsync(string idempotencyKey, string ocpApimSubscriptionKey, string merchantSerialNumber, CreatePaymentRequest createPaymentRequest, string vippsSystemName = default(string), string vippsSystemVersion = default(string), string vippsSystemPluginName = default(string), string vippsSystemPluginVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            Vipps.net.Models.Epayment.Client.ApiResponse<CreatePaymentResponse> localVarResponse = await CreatePaymentWithHttpInfoAsync(idempotencyKey, ocpApimSubscriptionKey, merchantSerialNumber, createPaymentRequest, vippsSystemName, vippsSystemVersion, vippsSystemPluginName, vippsSystemPluginVersion, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CreatePaymentResponse)</returns>
        public async System.Threading.Tasks.Task<Vipps.net.Models.Epayment.Client.ApiResponse<CreatePaymentResponse>> CreatePaymentWithHttpInfoAsync(string idempotencyKey, string ocpApimSubscriptionKey, string merchantSerialNumber, CreatePaymentRequest createPaymentRequest, string vippsSystemName = default(string), string vippsSystemVersion = default(string), string vippsSystemPluginName = default(string), string vippsSystemPluginVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'idempotencyKey' is set
            if (idempotencyKey == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<CreatePaymentResponse>("/v1/payments", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
