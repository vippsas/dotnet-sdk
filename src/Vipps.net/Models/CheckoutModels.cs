...
namespace Vipps.net.Models
{
    using System = global::System;

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.18.2.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v10.0.0.0))")]
    public partial class VippsCheckout 
    {
        private string _baseUrl = "https://apitest.vipps.no/checkout/v3";
        ...
        public virtual System.Threading.Tasks.Task<InitiateSessionResponse> SessionPOSTAsync(string vipps_System_Name, string vipps_System_Version, string vipps_System_Plugin_Name, string vipps_System_Plugin_Version, string client_id, string client_secret, string ocp_Apim_Subscription_Key, string merchant_Serial_Number, InitiateSessionRequest body)
        {
            return SessionPOSTAsync(vipps_System_Name, vipps_System_Version, vipps_System_Plugin_Name, vipps_System_Plugin_Version, client_id, client_secret, ocp_Apim_Subscription_Key, merchant_Serial_Number, body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<InitiateSessionResponse> SessionPOSTAsync(string vipps_System_Name, string vipps_System_Version, string vipps_System_Plugin_Name, string vipps_System_Plugin_Version, string client_id, string client_secret, string ocp_Apim_Subscription_Key, string merchant_Serial_Number, InitiateSessionRequest body, System.Threading.CancellationToken cancellationToken)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<SessionResponse> SessionGETAsync(string reference, string vipps_System_Name, string vipps_System_Version, string vipps_System_Plugin_Name, string vipps_System_Plugin_Version, string client_id, string client_secret, string ocp_Apim_Subscription_Key, string merchant_Serial_Number)
        {
            return SessionGETAsync(reference, vipps_System_Name, vipps_System_Version, vipps_System_Plugin_Name, vipps_System_Plugin_Version, client_id, client_secret, ocp_Apim_Subscription_Key, merchant_Serial_Number, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SessionResponse> SessionGETAsync(string reference, string vipps_System_Name, string vipps_System_Version, string vipps_System_Plugin_Name, string vipps_System_Plugin_Version, string client_id, string client_secret, string ocp_Apim_Subscription_Key, string merchant_Serial_Number, System.Threading.CancellationToken cancellationToken)
        {
            if (reference == null)
                throw new System.ArgumentNullException("reference");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/session/{reference}");
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 404)
                        {
                            ...
                            throw new ApiException("The specified session id is unknown.", status_, responseText_, headers_, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
    ...
    /// <summary>
    /// Certificate Configuration required to enable swish integration
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.2.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v10.0.0.0))")]
    public partial class CertificateInformation
    {
        ...
        /// <summary>
        /// The passphrase for the certificate or key
        /// </summary>
        [Newtonsoft.Json.JsonProperty("certificatePassword", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        public string CertificatePassword { get; set; }

        /// <summary>
        /// Base 64 encoded string of the private key.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("key", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Key { get; set; }

        /// <summary>
        /// Base 64 encoded string of the Certificate Authority of the certificate
        /// </summary>
        [Newtonsoft.Json.JsonProperty("certificateAuthority", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class PaymentMerchantInfo
    {
        ...
        /// <summary>
        /// Required information if you wish to enable Swish payments.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("swish", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public enum PaymentMethod
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"Swish")]
        Swish = 2,
    ...
    /// <summary>
    /// Configuration required to enable swish integration
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.2.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v10.0.0.0))")]
    public partial class Swish
    {
        /// <summary>
        /// The merchant's swish number
        /// </summary>
        [Newtonsoft.Json.JsonProperty("swishNumber", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        ...
        [Newtonsoft.Json.JsonProperty("certificateInformation", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
