...
namespace Vipps.Models.Autogen.Epayment
{
    ...
    public partial class CreatePaymentRequest
    {
        ...
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public CreatePaymentRequestCustomerInteraction CustomerInteraction { get; set; } = Vipps.Models.Autogen.Epayment.CreatePaymentRequestCustomerInteraction.CUSTOMER_NOT_PRESENT;
    ...
    public partial class QrFormat
    {
        ...
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public QrFormatFormat Format { get; set; } = Vipps.Models.Autogen.Epayment.QrFormatFormat.IMAGE_SVG_XML;
