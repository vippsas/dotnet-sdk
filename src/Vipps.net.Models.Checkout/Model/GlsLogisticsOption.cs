...
namespace Vipps.net.Models.Checkout.Model
{
    ...
    /// GlsLogisticsOption
    /// </summary>
    [DataContract(Name = "GlsLogisticsOption")]
    public partial class GlsLogisticsOption : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GlsLogisticsOption" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GlsLogisticsOption() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GlsLogisticsOption" /> class.
        /// </summary>
        ...
        /// <param name="brand">brand (required) (default to &quot;GLS&quot;).</param>
        /// <param name="id">id (required).</param>
        /// <param name="priority">priority (required).</param>
        /// <param name="isDefault">isDefault (required).</param>
        /// <param name="description">description.</param>
        public GlsLogisticsOption(Amount amount = default(Amount), GlsLogisticsType? type = default(GlsLogisticsType?), string customType = default(string), int? taxRate = default(int?), string brand = @"GLS", string id = default(string), int priority = default(int), bool isDefault = default(bool), string description = default(string))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for GlsLogisticsOption and cannot be null");
            }
            this.Amount = amount;
            // to ensure "brand" is required (not null)
            if (brand == null)
            {
                throw new ArgumentNullException("brand is a required property for GlsLogisticsOption and cannot be null");
            }
            this.Brand = brand;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for GlsLogisticsOption and cannot be null");
            }
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlsLogisticsOption {\n");
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.Brand != null) {
                ...
                Regex regexBrand = new Regex(@"GLS", RegexOptions.CultureInvariant);
