...
namespace Vipps.net.Models.Checkout.Model
{
    ...
    /// DaoLogisticsOption
    /// </summary>
    [DataContract(Name = "DaoLogisticsOption")]
    public partial class DaoLogisticsOption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DaoLogisticsOption" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DaoLogisticsOption() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DaoLogisticsOption" /> class.
        /// </summary>
        ...
        /// <param name="brand">brand (required) (default to &quot;DAO&quot;).</param>
        /// <param name="id">id (required).</param>
        /// <param name="priority">priority (required).</param>
        /// <param name="isDefault">isDefault (required).</param>
        /// <param name="description">description.</param>
        public DaoLogisticsOption(Amount amount = default(Amount), int type = default(int), string customType = default(string), int? taxRate = default(int?), string brand = @"DAO", string id = default(string), int priority = default(int), bool isDefault = default(bool), string description = default(string))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for DaoLogisticsOption and cannot be null");
            }
            this.Amount = amount;
            // to ensure "brand" is required (not null)
            if (brand == null)
            {
                throw new ArgumentNullException("brand is a required property for DaoLogisticsOption and cannot be null");
            }
            this.Brand = brand;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for DaoLogisticsOption and cannot be null");
            }
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DaoLogisticsOption {\n");
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.Brand != null) {
                ...
                Regex regexBrand = new Regex(@"DAO", RegexOptions.CultureInvariant);
