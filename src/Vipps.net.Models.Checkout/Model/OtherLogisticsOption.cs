...
namespace Vipps.net.Models.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OtherLogisticsOption")]
    public partial class OtherLogisticsOption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OtherLogisticsOption" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OtherLogisticsOption() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OtherLogisticsOption" /> class.
        /// </summary>
        ...
        /// <param name="brand">brand (required) (default to &quot;OTHER&quot;).</param>
        /// <param name="id">id (required).</param>
        /// <param name="priority">priority (required).</param>
        /// <param name="isDefault">isDefault (required).</param>
        /// <param name="description">description.</param>
        public OtherLogisticsOption(string title = default(string), Amount amount = default(Amount), int? taxRate = default(int?), string brand = @"OTHER", string id = default(string), int priority = default(int), bool isDefault = default(bool), string description = default(string))
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for OtherLogisticsOption and cannot be null");
            }
            this.Title = title;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for OtherLogisticsOption and cannot be null");
            }
            this.Amount = amount;
            // to ensure "brand" is required (not null)
            if (brand == null)
            {
                throw new ArgumentNullException("brand is a required property for OtherLogisticsOption and cannot be null");
            }
            this.Brand = brand;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for OtherLogisticsOption and cannot be null");
            }
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OtherLogisticsOption {\n");
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.Brand != null) {
                ...
                Regex regexBrand = new Regex(@"OTHER", RegexOptions.CultureInvariant);
