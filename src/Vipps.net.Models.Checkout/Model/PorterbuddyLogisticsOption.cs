...
namespace Vipps.net.Models.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PorterbuddyLogisticsOption")]
    public partial class PorterbuddyLogisticsOption : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PorterbuddyLogisticsOption" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PorterbuddyLogisticsOption() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PorterbuddyLogisticsOption" /> class.
        /// </summary>
        /// <param name="amount">Amounts are specified in minor units. For example: 10.00 NOK should be written as 1000; 20.50 EUR should be written as 2050..</param>
        ...
        /// <param name="brand">brand (required) (default to &quot;PORTERBUDDY&quot;).</param>
        /// <param name="id">id (required).</param>
        /// <param name="priority">priority (required).</param>
        /// <param name="isDefault">isDefault (required).</param>
        /// <param name="description">description.</param>
        public PorterbuddyLogisticsOption(Amount amount = default(Amount), PorterbuddyLogisticsType? type = default(PorterbuddyLogisticsType?), string customType = default(string), int? taxRate = default(int?), string brand = @"PORTERBUDDY", string id = default(string), int priority = default(int), bool isDefault = default(bool), string description = default(string))
        {
            // to ensure "brand" is required (not null)
            if (brand == null)
            {
                throw new ArgumentNullException("brand is a required property for PorterbuddyLogisticsOption and cannot be null");
            }
            this.Brand = brand;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PorterbuddyLogisticsOption and cannot be null");
            }
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PorterbuddyLogisticsOption {\n");
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.Brand != null) {
                ...
                Regex regexBrand = new Regex(@"PORTERBUDDY", RegexOptions.CultureInvariant);
